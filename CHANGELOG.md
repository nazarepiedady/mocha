...
## [12.0.0-beta-1](https://github.com/nazarepiedady/mocha/compare/v12.0.0-beta.10...v12.0.0-beta-1) (2026-02-23)


### ⚠ BREAKING CHANGES

* cleanup references of --compilers ([#5403](https://github.com/nazarepiedady/mocha/issues/5403))
* change the default of --forbid-only to check for process.env.CI ([#5496](https://github.com/nazarepiedady/mocha/issues/5496))
* bump minimum Node.js version from 18.18.0 to 20.19.0 ([#5477](https://github.com/nazarepiedady/mocha/issues/5477))
...
* add --fail-hook-affected-tests option to report skipped tests as failed ([#5519](https://github.com/nazarepiedady/mocha/issues/5519)) ([0ed524a](https://github.com/nazarepiedady/mocha/commit/0ed524af347b59200e03b972c2450d36f6818a45))
...
* add mocha.mjs export ([#5527](https://github.com/nazarepiedady/mocha/issues/5527)) ([e1cf23c](https://github.com/nazarepiedady/mocha/commit/e1cf23cbc2049a375ab9980337dbf2486450f7cb))
...
* allow FIFOs as test files ([#5512](https://github.com/nazarepiedady/mocha/issues/5512)) ([ca4af43](https://github.com/nazarepiedady/mocha/commit/ca4af439d5766fdfb2b5a7d7e06db0280b1abb6e))
...
* bump minimum Node.js version from 18.18.0 to 20.19.0 ([#5477](https://github.com/nazarepiedady/mocha/issues/5477)) ([1c34eef](https://github.com/nazarepiedady/mocha/commit/1c34eef426f29e5e46ec348272ccaa869ae43922))
* bump serialize-javascript from 6.0.2 to 7.0.2 ([#5589](https://github.com/nazarepiedady/mocha/issues/5589)) ([24fb1b6](https://github.com/nazarepiedady/mocha/commit/24fb1b6f8a45b4ca93b4577838bc1d9a47c74ec1))
* bump strip-json-comments from 3 to 5 ([#5484](https://github.com/nazarepiedady/mocha/issues/5484)) ([9b0db24](https://github.com/nazarepiedady/mocha/commit/9b0db24740c65717dcd1838dcafccbfc1c538d3b))
...
* change the default of --forbid-only to check for process.env.CI ([#5496](https://github.com/nazarepiedady/mocha/issues/5496)) ([3d94dde](https://github.com/nazarepiedady/mocha/commit/3d94ddea2f45d18473bf00e71db2b9766ab227fe))
* cleanup references of --compilers ([#5403](https://github.com/nazarepiedady/mocha/issues/5403)) ([f75d150](https://github.com/nazarepiedady/mocha/commit/f75d150cf6115334e7f14b8ee1fbbda04eb87087))
...
* ESM configuration file ([#5397](https://github.com/nazarepiedady/mocha/issues/5397)) ([dff9d78](https://github.com/nazarepiedady/mocha/commit/dff9d7873f2d47a799e0adef338a7d6045ba0731))
* **esm:** ability to decorate ESM module name before importing it ([#4945](https://github.com/nazarepiedady/mocha/issues/4945)) ([73bb819](https://github.com/nazarepiedady/mocha/commit/73bb81904fa017fc474973ce9b1e8fc325709142))
...
* migrate Markdown lint to `@eslint/markdown` ([#5593](https://github.com/nazarepiedady/mocha/issues/5593)) ([d9e1f0a](https://github.com/nazarepiedady/mocha/commit/d9e1f0aa7e39caa11edb81581c14cd02b3f40b3f))
...
* remove `log-symbols` dependency ([#5469](https://github.com/nazarepiedady/mocha/issues/5469)) ([b92168f](https://github.com/nazarepiedady/mocha/commit/b92168f5625be7343fb94d458d8a055cca8ff0a4))
* remove Sauce Labs ([#5700](https://github.com/nazarepiedady/mocha/issues/5700)) ([625c34e](https://github.com/nazarepiedady/mocha/commit/625c34e8469562dbde8440c2b4d64e820f7019fa))
...
* allow chain call timeout to override nested items timeout ([#5612](https://github.com/nazarepiedady/mocha/issues/5612)) ([5525da6](https://github.com/nazarepiedady/mocha/commit/5525da60cf8d2596e14ff5441ea518d47bd732da))
* allow importing ESM interface and reporters ([#5563](https://github.com/nazarepiedady/mocha/issues/5563)) ([bc9fc84](https://github.com/nazarepiedady/mocha/commit/bc9fc842213d00cf7ac4a4b0de898bf29e38bdad))
...
* bump diff dependency to ^8.0.3 ([#5674](https://github.com/nazarepiedady/mocha/issues/5674)) ([15fb31a](https://github.com/nazarepiedady/mocha/commit/15fb31a8b25a4d03242e5c5f901ff3800889263e))
...
* change Pending to properly extend Error ([#5679](https://github.com/nazarepiedady/mocha/issues/5679)) ([158effd](https://github.com/nazarepiedady/mocha/commit/158effd7de677c21b3a4ccd79ce0879fe0f97f8b))
...
* configurable max diff size ([#4799](https://github.com/nazarepiedady/mocha/issues/4799)) ([11c4560](https://github.com/nazarepiedady/mocha/commit/11c45609b56dda11460b1f8e0d2a415cf8f9915d))
...
* correct assertion import syntax in getting-started guide ([#5526](https://github.com/nazarepiedady/mocha/issues/5526)) ([fb0215b](https://github.com/nazarepiedady/mocha/commit/fb0215bd4fba44fde0cc7b8f9b91a4f07020a13b))
...
* **deps:** update dependency chokidar to v5 ([#5734](https://github.com/nazarepiedady/mocha/issues/5734)) ([ff2f17f](https://github.com/nazarepiedady/mocha/commit/ff2f17fb25e5001420d48035f81f5b19a5f0974f))
* **deps:** update dependency minimatch to v10 ([#5743](https://github.com/nazarepiedady/mocha/issues/5743)) ([3f3e449](https://github.com/nazarepiedady/mocha/commit/3f3e449f889cb2ddcf950e7bf2268091000b9f7c))
* **deps:** update dependency starlight-package-managers to ^0.12.0 ([#5717](https://github.com/nazarepiedady/mocha/issues/5717)) ([aa4ba48](https://github.com/nazarepiedady/mocha/commit/aa4ba483a4a25f5dfc36334439caf2b8935874d2))
* **deps:** update dependency workerpool to v10 ([#5751](https://github.com/nazarepiedady/mocha/issues/5751)) ([96a4768](https://github.com/nazarepiedady/mocha/commit/96a476831b2852e440357a450c3aebaec0bdb20f))
...
* **docs-next:** backer's logo is consistent regardless of size ([#5594](https://github.com/nazarepiedady/mocha/issues/5594)) ([1a53a10](https://github.com/nazarepiedady/mocha/commit/1a53a100a4f3b83a725ccf3c166dcbefebca8602))
...
* fail with an informative error message on a file with a broken default import ([#5413](https://github.com/nazarepiedady/mocha/issues/5413)) ([b0e6135](https://github.com/nazarepiedady/mocha/commit/b0e61350594f2a044bf34ea153d1fab1e82e80cc))
...
* handle empty null-prototyped objects ([#5506](https://github.com/nazarepiedady/mocha/issues/5506)) ([2a0bce0](https://github.com/nazarepiedady/mocha/commit/2a0bce02f6f696c74fb8fdcd9f72089e82935903))
...
* import() fallback prevention ([#5647](https://github.com/nazarepiedady/mocha/issues/5647)) ([6a78fa3](https://github.com/nazarepiedady/mocha/commit/6a78fa39576ffb42700811661a94c9ac996707f2))
...
* load mjs files correctly ([#5429](https://github.com/nazarepiedady/mocha/issues/5429)) ([a947b9b](https://github.com/nazarepiedady/mocha/commit/a947b9b95501a35efa73c18aa57a74dad555c03a))
...
* print helpful message when internal CLI error happens ([#5344](https://github.com/nazarepiedady/mocha/issues/5344)) ([1e11836](https://github.com/nazarepiedady/mocha/commit/1e118367dbb27f558edb7389985cca97d6d7da4b))
...
* remove `run` and use globalThis `setup` ([#5592](https://github.com/nazarepiedady/mocha/issues/5592)) ([1544c39](https://github.com/nazarepiedady/mocha/commit/1544c39dcd76916cca23a111c88eee8cbb781c24))
...
* surface ts-node compile errors ([#5572](https://github.com/nazarepiedady/mocha/issues/5572)) ([add4cf8](https://github.com/nazarepiedady/mocha/commit/add4cf8166b330c9af4342def643c606459331d7))
* switch from ansi-colors to picocolors ([#5323](https://github.com/nazarepiedady/mocha/issues/5323)) ([7c08d09](https://github.com/nazarepiedady/mocha/commit/7c08d0944d2255084bc4415238430b13c90f0df5))
...
* use original require() error for TS files if ERR_UNKNOWN_FILE_EXTENSION ([#5408](https://github.com/nazarepiedady/mocha/issues/5408)) ([ebdbc48](https://github.com/nazarepiedady/mocha/commit/ebdbc487693254498de62068c59e3e43d078eff1))
* use semver dot separator for beta pre-release versions (beta-X → beta.X) ([#5764](https://github.com/nazarepiedady/mocha/issues/5764)) ([5574738](https://github.com/nazarepiedady/mocha/commit/557473828570f8883c55cb0e450f153f3f9f8f74))
...
* watch mode using chokidar v4 ([#5379](https://github.com/nazarepiedady/mocha/issues/5379)) ([c2667c3](https://github.com/nazarepiedady/mocha/commit/c2667c3b3fca33c21306f59a1cca55bb7e1dac1f))
...
* add banner from old site to new site, link from new to old ([#5414](https://github.com/nazarepiedady/mocha/issues/5414)) ([dedef11](https://github.com/nazarepiedady/mocha/commit/dedef110a2af2f8632fb6c1b864fa0a46ad6ca9c))
...
* add info on spies to legacy docs ([#5421](https://github.com/nazarepiedady/mocha/issues/5421)) ([21f5544](https://github.com/nazarepiedady/mocha/commit/21f554459c75f5a75b22556b6e2ac70d6ac0e9fc))
* add instructions for API docs ([#5287](https://github.com/nazarepiedady/mocha/issues/5287)) ([b720ec1](https://github.com/nazarepiedady/mocha/commit/b720ec1b3ca630a90f80311da391b2a0cdfead4e))
* add maintainer expectations to MAINTAINERS.md ([#5514](https://github.com/nazarepiedady/mocha/issues/5514)) ([76f95a1](https://github.com/nazarepiedady/mocha/commit/76f95a1113ea0472800ff6b1781f2750836a6db7))
* add major release strategy, fix typos ([#5551](https://github.com/nazarepiedady/mocha/issues/5551)) ([ec0fe0d](https://github.com/nazarepiedady/mocha/commit/ec0fe0d17401495ad01db3b5bc1adad1f5547009))
* add missing /next/* redirects ([#5627](https://github.com/nazarepiedady/mocha/issues/5627)) ([8fa183d](https://github.com/nazarepiedady/mocha/commit/8fa183d592b29346901b55e2fa479c8f598a1ec3))
...
* add security escalation policy ([#5466](https://github.com/nazarepiedady/mocha/issues/5466)) ([4122c7d](https://github.com/nazarepiedady/mocha/commit/4122c7d13d0941be451365397fbf43e1f3103027))
...
* bumped docs-next Astro to ^5.16.6 ([#5574](https://github.com/nazarepiedady/mocha/issues/5574)) ([806222b](https://github.com/nazarepiedady/mocha/commit/806222b0998ffb4d09399090f4ec638e90974427))
...
* fix client redirects ([#5697](https://github.com/nazarepiedady/mocha/issues/5697)) ([dd9145d](https://github.com/nazarepiedady/mocha/commit/dd9145dd9c5a684aa918ca5ed10155293df2bb91)), closes [#5696](https://github.com/nazarepiedady/mocha/issues/5696)
...
* fix duplicate global leak documentation ([#5461](https://github.com/nazarepiedady/mocha/issues/5461)) ([1164b9d](https://github.com/nazarepiedady/mocha/commit/1164b9da895e56cf745acda2792e634080018ff6))
...
* fix light mode Astro accent text color ([#5585](https://github.com/nazarepiedady/mocha/issues/5585)) ([9cc3ada](https://github.com/nazarepiedady/mocha/commit/9cc3ada85b4ab4a4f2a8c7dc1b9d9ff8f101ffc1))
* fix links in new site ([#5416](https://github.com/nazarepiedady/mocha/issues/5416)) ([b2bc769](https://github.com/nazarepiedady/mocha/commit/b2bc769c6c8d87311ba0bdc9df8b9b588494eba5))
...
* fix v3_older changelog duplicate headings ([#5602](https://github.com/nazarepiedady/mocha/issues/5602)) ([a750518](https://github.com/nazarepiedady/mocha/commit/a7505180b64541ac71639ec3d1193f26e73527d9))
...
* improve 'grep()' and clarify docs ([#4714](https://github.com/nazarepiedady/mocha/issues/4714)) ([757b85d](https://github.com/nazarepiedady/mocha/commit/757b85dd230079901b181c68f0be82b9a3de6407))
...
* migrate assertion libraries wiki link to main docs ([#5442](https://github.com/nazarepiedady/mocha/issues/5442)) ([95f3ca8](https://github.com/nazarepiedady/mocha/commit/95f3ca8bc3a6c6af2932f7fd59a404768c0c6693))
* migrate count assertions wiki page to docs ([#5438](https://github.com/nazarepiedady/mocha/issues/5438)) ([02a306c](https://github.com/nazarepiedady/mocha/commit/02a306c6cbf31f4eef7d4c9bf5e06c917d3efc11))
* migrate how-to wiki pages to main documentation ([#5463](https://github.com/nazarepiedady/mocha/issues/5463)) ([b85aec6](https://github.com/nazarepiedady/mocha/commit/b85aec6e4307903f31b2b8039dd749efc44ffcf5))
* migrate programmatic usage to docs, development content to DEVELOPMENT.md ([#5464](https://github.com/nazarepiedady/mocha/issues/5464)) ([cb47925](https://github.com/nazarepiedady/mocha/commit/cb47925f99b39bd66bdd09218395bf5e0a54802d))
* migrate remaining legacy wiki pages to main documentation ([#5465](https://github.com/nazarepiedady/mocha/issues/5465)) ([bff9166](https://github.com/nazarepiedady/mocha/commit/bff91660733b71b124aad939538dee7747cfbeb8))
* migrate shared behaviours to docs-next ([#5432](https://github.com/nazarepiedady/mocha/issues/5432)) ([1dc4aa9](https://github.com/nazarepiedady/mocha/commit/1dc4aa98eb3793865fa2a4da3373534dafc1c9a7))
* migrate Spies wiki page to explainers ([#5420](https://github.com/nazarepiedady/mocha/issues/5420)) ([cbcf007](https://github.com/nazarepiedady/mocha/commit/cbcf007c5ae25f203863aac0b43eca1e8aefe093))
* Migrate tagging wiki page to docs ([#5435](https://github.com/nazarepiedady/mocha/issues/5435)) ([876247a](https://github.com/nazarepiedady/mocha/commit/876247a8a636cc7bb1c3bf31390e7771182a090a))
* migrate third party reporters wiki page to docs ([#5433](https://github.com/nazarepiedady/mocha/issues/5433)) ([f70764c](https://github.com/nazarepiedady/mocha/commit/f70764c9a56fcf12e316d5539788c7be0693b6a9))
* migrate third party UIs wiki page to docs ([#5434](https://github.com/nazarepiedady/mocha/issues/5434)) ([6654704](https://github.com/nazarepiedady/mocha/commit/66547045cb9bd2fa8209b34c36da2a5ef49d23fc))
* migrate to global leak wiki page to docs ([#5437](https://github.com/nazarepiedady/mocha/issues/5437)) ([8a6fdca](https://github.com/nazarepiedady/mocha/commit/8a6fdcafccd94c888fae5e8be47dd29a604241b6))
...
* test/integration/README: remove ref to non-existent dir ([#5516](https://github.com/nazarepiedady/mocha/issues/5516)) ([d2c2d40](https://github.com/nazarepiedady/mocha/commit/d2c2d4026d0f6a09b96344f034e9cba9ee6277af))
...
* update /next bug report link to be docs issue template ([#5424](https://github.com/nazarepiedady/mocha/issues/5424)) ([668cb66](https://github.com/nazarepiedady/mocha/commit/668cb66e1288051369ab144ccb50c840ebe34267))
* update Contributor License Agreement link in CONTRIBUTING.md ([#5567](https://github.com/nazarepiedady/mocha/issues/5567)) ([410ce0d](https://github.com/nazarepiedady/mocha/commit/410ce0d2a0f799aaca2c0bc627294d70c62dd3f4))
* update maintainer release notes for release-please ([#5453](https://github.com/nazarepiedady/mocha/issues/5453)) ([185ae1e](https://github.com/nazarepiedady/mocha/commit/185ae1eabe5c1e92c758bdfb398f7f47b6ef9483))
...
* update sponsor image to be larger ([#5659](https://github.com/nazarepiedady/mocha/issues/5659)) ([bbe2bdb](https://github.com/nazarepiedady/mocha/commit/bbe2bdbb69f7aa560645a5ab2cbd596dd0b43448))
...
* add Knip to docs-next, remove unused deps, and cleanup links ([#5726](https://github.com/nazarepiedady/mocha/issues/5726)) ([a3908e9](https://github.com/nazarepiedady/mocha/commit/a3908e9008c946f3bcc321c2ef630b587727fce4))
...
* applied formatting to all files ([#5493](https://github.com/nazarepiedady/mocha/issues/5493)) ([76d7194](https://github.com/nazarepiedady/mocha/commit/76d719495d09dc4afb37d1179ede8911c52a011e))
* bump CI to use 20.19.4, 22.18.0, 24.6.0 ([#5430](https://github.com/nazarepiedady/mocha/issues/5430)) ([ace5eb4](https://github.com/nazarepiedady/mocha/commit/ace5eb47a7926fe9d56ebcd95fd659c557a5be4d))
...
* bump glob to version 13 ([#5546](https://github.com/nazarepiedady/mocha/issues/5546)) ([f4d4ad2](https://github.com/nazarepiedady/mocha/commit/f4d4ad23e9e994668c7d95c5a9bf59f581dccebf))
...
* **ci:** use OIDC token for trusted publishing to `npm` ([#5610](https://github.com/nazarepiedady/mocha/issues/5610)) ([dc0fdb7](https://github.com/nazarepiedady/mocha/commit/dc0fdb767fe46b885f7a0ccfb67acfb453156a3b))
...
* cleanup issue templates ([#5624](https://github.com/nazarepiedady/mocha/issues/5624)) ([1972dd7](https://github.com/nazarepiedady/mocha/commit/1972dd76ec66e8e11532bb6aca9157c4f8892d3c))
...
* Configure Renovate ([#5678](https://github.com/nazarepiedady/mocha/issues/5678)) ([a9c9b90](https://github.com/nazarepiedady/mocha/commit/a9c9b90098a831d82e69d82bfc7ce8c7aa749911))
* create exclusions for nyc ([#5609](https://github.com/nazarepiedady/mocha/issues/5609)) ([702473a](https://github.com/nazarepiedady/mocha/commit/702473a54d9348948a63b4600171afa6956ccb0b))
...
* **deps:** update dependency @rollup/plugin-alias to v6 ([#5718](https://github.com/nazarepiedady/mocha/issues/5718)) ([267d751](https://github.com/nazarepiedady/mocha/commit/267d751dd05270de4e18e0348584fbb12d90ce04))
* **deps:** update dependency @rollup/plugin-commonjs to v29 ([#5719](https://github.com/nazarepiedady/mocha/issues/5719)) ([9ed4ee5](https://github.com/nazarepiedady/mocha/commit/9ed4ee55d975281ea54f237d23666d7b0307a596))
* **deps:** update dependency astro to v5.17.1 ([#5703](https://github.com/nazarepiedady/mocha/issues/5703)) ([ec3d1fa](https://github.com/nazarepiedady/mocha/commit/ec3d1fa02e285a4430942942c11c376e63d395ca))
* **deps:** update dependency chai to v4.5.0 ([#5705](https://github.com/nazarepiedady/mocha/issues/5705)) ([870f9f8](https://github.com/nazarepiedady/mocha/commit/870f9f8df7d1f9cace40bfc29a9b5b79a26ccb4e))
* **deps:** update dependency cross-env to v10 ([#5721](https://github.com/nazarepiedady/mocha/issues/5721)) ([20b7476](https://github.com/nazarepiedady/mocha/commit/20b7476904592b356a48c3f89817e930c78f15cb))
* **deps:** update dependency knip to v5.83.1 ([#5708](https://github.com/nazarepiedady/mocha/issues/5708)) ([d833413](https://github.com/nazarepiedady/mocha/commit/d833413622807c91cc2dea243c2be3518e2fe10b))
* **deps:** update dependency npm-run-all2 to v8 ([#5727](https://github.com/nazarepiedady/mocha/issues/5727)) ([e38e0ec](https://github.com/nazarepiedady/mocha/commit/e38e0ec3dd91be11b2b999959e6245ec721168e3))
* **deps:** update dependency prettier to v3.8.1 ([#5709](https://github.com/nazarepiedady/mocha/issues/5709)) ([2f98cfd](https://github.com/nazarepiedady/mocha/commit/2f98cfd1e3e9fce8a3c1a645f99a6b4b3b69ea6c))
* **deps:** update dependency rimraf to v6 ([#5728](https://github.com/nazarepiedady/mocha/issues/5728)) ([ba124e9](https://github.com/nazarepiedady/mocha/commit/ba124e9161e5efd052df77dda50925c5666ccd6d))
* **deps:** update dependency rollup to v4.57.1 ([#5710](https://github.com/nazarepiedady/mocha/issues/5710)) ([178749d](https://github.com/nazarepiedady/mocha/commit/178749da1bee978b5ef109a253337ae88206365c))
* **deps:** update dependency unexpected-map to v3 ([#5736](https://github.com/nazarepiedady/mocha/issues/5736)) ([c1f3379](https://github.com/nazarepiedady/mocha/commit/c1f33798ab925c76c5f9a69dcb8c1ce71da2fbc9))
* **deps:** update dependency unist-util-visit to v5.1.0 ([#5711](https://github.com/nazarepiedady/mocha/issues/5711)) ([7ede894](https://github.com/nazarepiedady/mocha/commit/7ede8943ff8f7925b51d4e4a226ee76b0a77619d))
* **deps:** update dependency webdriverio to v9 ([#5739](https://github.com/nazarepiedady/mocha/issues/5739)) ([ff334df](https://github.com/nazarepiedady/mocha/commit/ff334df744c93f27c7cce08ced320833ee69cb2f))
* **deps:** update dependency webpack-cli to v6 ([#5741](https://github.com/nazarepiedady/mocha/issues/5741)) ([95c9d75](https://github.com/nazarepiedady/mocha/commit/95c9d75120078e4c1fbb87d23f4fd7ec1f8a5405))
* **deps:** update dependency workerpool to v9.3.4 ([#5715](https://github.com/nazarepiedady/mocha/issues/5715)) ([c030a3b](https://github.com/nazarepiedady/mocha/commit/c030a3bd4774db679ac8dc7d56e705975f1a1b6e))
* **deps:** update eslint monorepo to v10 (major) ([#5742](https://github.com/nazarepiedady/mocha/issues/5742)) ([fe9dc01](https://github.com/nazarepiedady/mocha/commit/fe9dc01850f1c191e758fd60a71d1db8b13cc968))
* **deps:** update remark ([#5745](https://github.com/nazarepiedady/mocha/issues/5745)) ([37a25f1](https://github.com/nazarepiedady/mocha/commit/37a25f174e6f3f16cae34923b86ab7d2504985ce))
...
* fix broken link in .github/CONTRIBUTING.md ([681e843](https://github.com/nazarepiedady/mocha/commit/681e843800051a9d3ab66c1bfb7ad71428e34315))
...
* fix timeout issue with some XUnit tests ([53cc467](https://github.com/nazarepiedady/mocha/commit/53cc46755571ed53e32254fb7d896f599a1a7d1f))
...
* have `Tests` workflow ignore more relevant paths ([#5762](https://github.com/nazarepiedady/mocha/issues/5762)) ([8e2cebe](https://github.com/nazarepiedady/mocha/commit/8e2cebe14505ce62b0597c854bec217c60c00020))
...
* **main:** release 10.7.3 ([#5195](https://github.com/nazarepiedady/mocha/issues/5195)) ([d5766c8](https://github.com/nazarepiedady/mocha/commit/d5766c887e72b1bb55d5efeac33b1cadd0544b84))
...
* **main:** release 11.7.2 ([#5398](https://github.com/nazarepiedady/mocha/issues/5398)) ([5f8e8a8](https://github.com/nazarepiedady/mocha/commit/5f8e8a89fb4cc833290549dcb1974be06514746b))
* **main:** release 11.7.3 ([#5455](https://github.com/nazarepiedady/mocha/issues/5455)) ([c805327](https://github.com/nazarepiedady/mocha/commit/c8053277699b35854eb926ffa7b3b5bebcfbdd44))
* **main:** release 11.7.4 ([#5473](https://github.com/nazarepiedady/mocha/issues/5473)) ([8649f39](https://github.com/nazarepiedady/mocha/commit/8649f394e469b0ec8612837b84707ac42ad2af62))
* **main:** release 12.0.0-beta-1 ([#5549](https://github.com/nazarepiedady/mocha/issues/5549)) ([e648324](https://github.com/nazarepiedady/mocha/commit/e6483245884847ae2e3e468956451ecb9dc31e12))
* **main:** release 12.0.0-beta-10 ([#5701](https://github.com/nazarepiedady/mocha/issues/5701)) ([6cb2710](https://github.com/nazarepiedady/mocha/commit/6cb27100c9a50c17a205803d343a2c369656f0ee))
* **main:** release 12.0.0-beta-2 ([#5552](https://github.com/nazarepiedady/mocha/issues/5552)) ([a7c7eb2](https://github.com/nazarepiedady/mocha/commit/a7c7eb2e2a21ed07a7d4f2ac04dca217eb1d27d3))
* **main:** release 12.0.0-beta-3 ([#5561](https://github.com/nazarepiedady/mocha/issues/5561)) ([8e595c8](https://github.com/nazarepiedady/mocha/commit/8e595c8aefe19e0b87b0ea929eda2a19fe050260))
* **main:** release 12.0.0-beta-4 ([#5598](https://github.com/nazarepiedady/mocha/issues/5598)) ([424516e](https://github.com/nazarepiedady/mocha/commit/424516ed3c34c6716afbf554425cf5df439cd86c))
* **main:** release 12.0.0-beta-4 ([#5620](https://github.com/nazarepiedady/mocha/issues/5620)) ([2fa505c](https://github.com/nazarepiedady/mocha/commit/2fa505ca70293fecaf5b4d8a2d79e108ebb7edfe))
* **main:** release 12.0.0-beta-5 ([#5626](https://github.com/nazarepiedady/mocha/issues/5626)) ([d220832](https://github.com/nazarepiedady/mocha/commit/d220832b8d1360d835d06cb48fd90be4a27d9a0d))
* **main:** release 12.0.0-beta-6 ([#5654](https://github.com/nazarepiedady/mocha/issues/5654)) ([047227f](https://github.com/nazarepiedady/mocha/commit/047227f7eb633c906e287d66b24f0486fe47519c))
* **main:** release 12.0.0-beta-7 ([#5660](https://github.com/nazarepiedady/mocha/issues/5660)) ([611b89d](https://github.com/nazarepiedady/mocha/commit/611b89d5f375748d181ea2a3e912214c6b4f26b1))
* **main:** release 12.0.0-beta-8 ([#5684](https://github.com/nazarepiedady/mocha/issues/5684)) ([bbd0ace](https://github.com/nazarepiedady/mocha/commit/bbd0ace3a489fd562e9881c50532d6e18db7eadc))
* **main:** release 12.0.0-beta-9 ([#5698](https://github.com/nazarepiedady/mocha/issues/5698)) ([430960c](https://github.com/nazarepiedady/mocha/commit/430960c32f239ce830c7cef87a636accfae33150))
...
* move callback and object typedefs to a new types.d.ts ([#5351](https://github.com/nazarepiedady/mocha/issues/5351)) ([3300d21](https://github.com/nazarepiedady/mocha/commit/3300d2155a1b06059fbe89c98a1d8bf979539019))
* move nyc config changes from package.json into .nycrc ([#5668](https://github.com/nazarepiedady/mocha/issues/5668)) ([e923e40](https://github.com/nazarepiedady/mocha/commit/e923e4063f6a24dcaf7c6d7c7a3c8be998cb7980))
* normalized ESLint config to v9's recommended structure ([#5575](https://github.com/nazarepiedady/mocha/issues/5575)) ([7f9ed1f](https://github.com/nazarepiedady/mocha/commit/7f9ed1fb3480e0658c2c7d84c60a1b505c941ce5))
...
* prevent unwanted Prettier rewrites ([#5591](https://github.com/nazarepiedady/mocha/issues/5591)) ([3ea1578](https://github.com/nazarepiedady/mocha/commit/3ea15789ddb4b77c591d9da36d2476ac359de00d))
...
* remove broken browser-test.yml ([#5615](https://github.com/nazarepiedady/mocha/issues/5615)) ([33ce345](https://github.com/nazarepiedady/mocha/commit/33ce345f9ab4f47573a4994c5c01de6eda2af45d))
...
* remove extra newline ([bbe2bdb](https://github.com/nazarepiedady/mocha/commit/bbe2bdbb69f7aa560645a5ab2cbd596dd0b43448))
...
* remove legacy `docs/` ([#5583](https://github.com/nazarepiedady/mocha/issues/5583)) ([d8c310e](https://github.com/nazarepiedady/mocha/commit/d8c310e3eddd235be55ad1891cde84c3be6f56f3))
...
* remove Node.js 18 from test-smoke in CI too ([d643105](https://github.com/nazarepiedady/mocha/commit/d643105aa6f3fbac9d13e8a44f4c4c7302512193))
...
* remove trailing spaces ([#5475](https://github.com/nazarepiedady/mocha/issues/5475)) ([7f68e5c](https://github.com/nazarepiedady/mocha/commit/7f68e5c1565606bcebeb715b8591c52973d00dff))
...
* remove unused assets folder ([#5638](https://github.com/nazarepiedady/mocha/issues/5638)) ([ddf8644](https://github.com/nazarepiedady/mocha/commit/ddf864482ff66b1ca46ef7f08e63ca923222e717))
* remove uuid dev dependency ([#5022](https://github.com/nazarepiedady/mocha/issues/5022)) ([ee2b70e](https://github.com/nazarepiedady/mocha/commit/ee2b70e8e82b0b67347d41028fa45521d43633d9))
...
* revert "chore(main): release 12.0.0-beta-4 ([#5598](https://github.com/nazarepiedady/mocha/issues/5598))" ([#5619](https://github.com/nazarepiedady/mocha/issues/5619)) ([dba8091](https://github.com/nazarepiedady/mocha/commit/dba809196541df415fac2681822f5cd35cf20442))
...
* rewrite base path instead of copy-pasting ([#5431](https://github.com/nazarepiedady/mocha/issues/5431)) ([c6c6740](https://github.com/nazarepiedady/mocha/commit/c6c6740fb45da43510f86c1d22ea46ce9ee6a7ae))
...
* run tests when PR is retargeted ([#5761](https://github.com/nazarepiedady/mocha/issues/5761)) ([3481b1e](https://github.com/nazarepiedady/mocha/commit/3481b1e32c3ad85e38af9639fc39b53685dd1922))
...
* switch from Coveralls to Codecov ([#5447](https://github.com/nazarepiedady/mocha/issues/5447)) ([f4e7e54](https://github.com/nazarepiedady/mocha/commit/f4e7e54eb285765d7c50bce9c501db2e1b1e22be))
* switch reporters from util.inherits to ES2015 classes ([#5180](https://github.com/nazarepiedady/mocha/issues/5180)) ([c3f32ce](https://github.com/nazarepiedady/mocha/commit/c3f32ce7e2f39d14beb325892953d3fb1c4922e6))
* switch Runnable, Hook, and Test from util.inherits to ES2015 classes ([#5178](https://github.com/nazarepiedady/mocha/issues/5178)) ([1378fd8](https://github.com/nazarepiedady/mocha/commit/1378fd86071a0c59c0a991569441fe398d0911d8))
* switch Suite from util.inherits to ES2015 classes ([#5179](https://github.com/nazarepiedady/mocha/issues/5179)) ([1ce690e](https://github.com/nazarepiedady/mocha/commit/1ce690e590ca7bff7f47b108d3a5cc61dde6aa1b))
...
* unify caught errors as err ([#5439](https://github.com/nazarepiedady/mocha/issues/5439)) ([d4912e7](https://github.com/nazarepiedady/mocha/commit/d4912e705cf9ae1c3aa274b6449a6a0ff6d408c5))
* unpin node-version in release-please ([#5550](https://github.com/nazarepiedady/mocha/issues/5550)) ([62c90cd](https://github.com/nazarepiedady/mocha/commit/62c90cd2aea4c719d2014e7134b2a1d7c189fd7a))
...
* Update experimental module detection test and pin exact Node versions ([#5417](https://github.com/nazarepiedady/mocha/issues/5417)) ([2489090](https://github.com/nazarepiedady/mocha/commit/2489090223f2629e4a380abe4cc6d46858ada922))
* update Rollup to v4 ([#5510](https://github.com/nazarepiedady/mocha/issues/5510)) ([cafa782](https://github.com/nazarepiedady/mocha/commit/cafa782f010021e7055f8482ede2c02c6503f0a0))
...
* update spam filter ([#5645](https://github.com/nazarepiedady/mocha/issues/5645)) ([cf945fb](https://github.com/nazarepiedady/mocha/commit/cf945fb73b7c5a74f0856cabca5b5b1c8a6ff1c8))
* update tagline ([#5635](https://github.com/nazarepiedady/mocha/issues/5635)) ([8ff0209](https://github.com/nazarepiedady/mocha/commit/8ff0209db575c8231eea77e6ab23e6fe95620c92))
* use `ps-list` instead of `pidtree` to remove wmic ([#5479](https://github.com/nazarepiedady/mocha/issues/5479)) ([b2985b3](https://github.com/nazarepiedady/mocha/commit/b2985b3428b4b88ca220a14a26e9eb7139e8d445))
* use OIDC to publish to npm ([#5681](https://github.com/nazarepiedady/mocha/issues/5681)) ([5567aed](https://github.com/nazarepiedady/mocha/commit/5567aed50a00b63074d5c7703c6d8196dee92088))
...
* **deps:** bump actions/checkout in the github-actions group ([#5419](https://github.com/nazarepiedady/mocha/issues/5419)) ([03ac2d0](https://github.com/nazarepiedady/mocha/commit/03ac2d0e6e75e95b3dc7fb08f2e1a1117d9718ca))
* **deps:** bump actions/checkout in the github-actions group ([#5547](https://github.com/nazarepiedady/mocha/issues/5547)) ([561eb03](https://github.com/nazarepiedady/mocha/commit/561eb039f7cfc36563a9583b17c7d4cb7ec30652))
* **deps:** bump actions/setup-node in the github-actions group ([#5459](https://github.com/nazarepiedady/mocha/issues/5459)) ([48c6f40](https://github.com/nazarepiedady/mocha/commit/48c6f4068b5d22ebc49220900f0b53f8ecdc2b74))
* **deps:** bump actions/setup-node in the github-actions group ([#5503](https://github.com/nazarepiedady/mocha/issues/5503)) ([9a70533](https://github.com/nazarepiedady/mocha/commit/9a7053349589344236b20301de965030eaabfea9))
* **deps:** bump OctoGuide/bot in the github-actions group ([#5648](https://github.com/nazarepiedady/mocha/issues/5648)) ([fed6bbd](https://github.com/nazarepiedady/mocha/commit/fed6bbdb891c518e61e8ef4bbf07ed46b469f860))
* **deps:** bump OctoGuide/bot in the github-actions group ([#5653](https://github.com/nazarepiedady/mocha/issues/5653)) ([e06cce7](https://github.com/nazarepiedady/mocha/commit/e06cce7a49b79a163e33db166e9b078b0d7b4001))
* **deps:** bump OctoGuide/bot in the github-actions group ([#5724](https://github.com/nazarepiedady/mocha/issues/5724)) ([87224d8](https://github.com/nazarepiedady/mocha/commit/87224d8400fa3b074f77a8ba1baadf7e0b99d864))
...
* **dep:** update `diff` from v7 to v8 ([#5605](https://github.com/nazarepiedady/mocha/issues/5605)) ([8ca311c](https://github.com/nazarepiedady/mocha/commit/8ca311c6c9b0d353b1c9d65b5751296d9baddd83))
* **dev-deps:** upgrade `eslint` from v8 to v9 ([#5559](https://github.com/nazarepiedady/mocha/issues/5559)) ([bb24ca8](https://github.com/nazarepiedady/mocha/commit/bb24ca8fde15471ff68d5b01b74c2d7e6047d966))
* **dev-deps:** upgrade `markdownlint-cli` to latest v0.46.0  ([#5560](https://github.com/nazarepiedady/mocha/issues/5560)) ([a124f1d](https://github.com/nazarepiedady/mocha/commit/a124f1d3b7d0f8277962cae295cd43878294e183))
* **dev-deps:** upgrade `nyc` from 15 to 17 ([#5556](https://github.com/nazarepiedady/mocha/issues/5556)) ([599ab01](https://github.com/nazarepiedady/mocha/commit/599ab013f526e78b3888a092a928ea4bc67138c0))
* **docs/dev-deps:** use JS-native `fetch` to get supporters data instead of external `needle` ([#5643](https://github.com/nazarepiedady/mocha/issues/5643)) ([e37e56f](https://github.com/nazarepiedady/mocha/commit/e37e56fbe6a1072f1784ef87278d46f7ac48cdb8))
* initial file implementation for ocotoguide ([#5608](https://github.com/nazarepiedady/mocha/issues/5608)) ([a5f5c64](https://github.com/nazarepiedady/mocha/commit/a5f5c6442505069573a17798a515f267c24a38f3))
* run `npm audit fix` ([#5695](https://github.com/nazarepiedady/mocha/issues/5695)) ([c7b00b0](https://github.com/nazarepiedady/mocha/commit/c7b00b0e4f03583c4dcc407f28a5453df436f32b))
* update npm command for format ([#5603](https://github.com/nazarepiedady/mocha/issues/5603)) ([c6a29cc](https://github.com/nazarepiedady/mocha/commit/c6a29ccb38f81d65100cb2a0e6d73ad4303f58fb))
